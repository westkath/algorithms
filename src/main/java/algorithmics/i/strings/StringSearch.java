...
public class StringSearch {
    ...
    public int kmp(String text, String pattern) {
        ...
        System.out.println(String.format("Border Table: %s", Arrays.toString(borderTable)));
    ...
    public int bm(String text, String pattern) {
        ...
        for (int index = 0; index < lastOccurrenceTable.length; index++) {
            System.out.println(String.format(" %s : %d", (char) index, lastOccurrenceTable[index]));
        }
